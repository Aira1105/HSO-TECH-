...
|----------------------------------|---------------|-------------------------------------------|-----------------------------|----------------------------------------|-------------------------------------------------------------|
|Allsec LILO *Important*           | Local  Machine | Google Chrome                             |  30secs/1min                | $\color{Blue}{\textsf{Low}                |  [`🔗`](https://www.allsechro.ph/OP360/Common/HomePage.aspx) |
...
|Remote Desktop                    | Local  Machine | Stand-alone App                           | 3mins/5mins                 | $\color{Blue}{\textsf{Low}}$                |                                                             |           
