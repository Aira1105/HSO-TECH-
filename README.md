...
|----------------------------------|---------------|-------------------------------------------|-----------------------------|----------------------------------------|-------------------------------------------------------------|
|Allsec LILO *Important*           | Local  Machine | Google Chrome                             |  30secs/1min                | $\color{Green}{\textsf{Low}}$     |  [`🔗`](https://www.allsechro.ph/OP360/Common/HomePage.aspx) |
|OP360 Google Suites               | Local  Machine | Google Chrome                             |  1min/2mins                 | $\color{Orange}{\textsf{Moderate}}$  |  [`🔗`](https://mail.google.com/mail/u/0/?pli=1#inbox)                                                            |
|Remote Desktop                    | Local  Machine | Stand-alone App                           | 3mins/5mins                 | $\color{Green}{\textsf{Low}}$                |                                                             |           
|Github Repository                 | Local  Machine | Google Chrome                             |  30secs/1min                |$\color{Green}{\textsf{Low}}$                |  [`🔗`](https://github.com/Aira1105/HSO-Tech)                                                            |
|Salesforce HS1 Support Console CRM| AVD/VMware    | Google Chrome                             |  2mins/4mins                | $\color{Red}{\textsf{High}}$               |  [`🔗`](https://henryscheinone.lightning.force.com/lightning/page/home)                                                            |
|Bomgar Remote                     | AVD/VMware    | Stand-alone App                           |  1min/2mins                 | $\color{Red}{\textsf{High}}$                  |                                                             |
|Dentrix-Core Software + Dentrix Ascend             | AVD/VMware    | Stand-alone App                           |  2mins/4mins                | $\color{Red}{\textsf{High}}$                  |                                                             |
|Microsoft Outlook                 | AVD/VMware    | Stand-alone App                           |  1min/2mins                 | $\color{Orange}{\textsf{Moderate}}$           |                                                             |
|Microsoft Teams                   | AVD/VMware    | Stand-alone App                           |  1min/2mins                 | $\color{Orange}{\textsf{Moderate}}$           |                                                             |
...
- HSO QA FORMS - [`Link`](https://docs.google.com/spreadsheets/d/1koAcRkV7DZX1vs2YqFT6KtpR8KZYl2ybjEbZExQXlNc/edit?gid=1256271695#gid=1256271695)
